<template>
  <div>
    ...
    <el-row>
      <el-col :span="24">
        <el-table v-loading="loading" :data="data" ref="table" border fit @selection-change="handleSelectionChange">
          ...
          <el-table-column prop="open_id" label="open_id" sortable></el-table-column>
    ...
    <recipient-dialog ref="recipient_dialog" type="sms" @getRecipientList="toGetRecipientList"></recipient-dialog>
  </div>
</template>
