  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on"
      ...
      <el-button :loading="loading" type="primary" style="width:100%;margin-bottom:20px;"
                 @click.native.prevent="handleLogin" size="medium">登 录
      </el-button>
      ...
      <span class="pull-right" style="color: #fff;font-size: 14px">
        没账号？ <span style="width:25%;margin-bottom:30px;font-size: 14px" class="span-color"  @click="goReg">去注册</span>
      </span>
